            ...
            <div className="flex items-center justify-center relative min-h-screen">
                {user ? (
                    <div className="text-center">
                        <p className="text-2xl text-white">Hello, {user.firstName}!</p>
                        <p className="text-base">Welcome to RaceCode.</p>
                        <Button className="m-8">Play</Button>
                    </div>
                ) : (
                    <div className="text-center">
                        <p className="text-2xl font-bold mt-8">Hello, world! Welcome to RaceCode.</p>
                        <p className="text-base mt-8">A 1v1 LeetCode blitz interview preparation game.</p>
                        <Link href="sign-in">
